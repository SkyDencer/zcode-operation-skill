...
const SCHEMA = {
  ...
  SKILL_ROUTER_RRF_BM25_WEIGHT: { min: 0, max: 1, type: 'float' },
  SKILL_ROUTER_RRF_SEMANTIC_WEIGHT: { min: 0, max: 1, type: 'float' },
...
function getPath(key) {
  const pathMap = {
    ...
    SKILL_ROUTER_RRF_BM25_WEIGHT: ['embeddings', 'weights', 'bm25'],
    SKILL_ROUTER_RRF_SEMANTIC_WEIGHT: ['embeddings', 'weights', 'semantic'],
